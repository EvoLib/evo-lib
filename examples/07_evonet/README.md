...
### `03_delay_bitseq_echo.py`

Demonstrates **evolution of recurrent delays** on a minimal **discrete echo task**.

The network receives a deterministic binary input sequence `u[t] ∈ {0,1}` and must
output the same sequence delayed by *k* steps (`u[t−k]`).
Unlike the sine-delay example, the delay is evolved rather than specified manually.
The task isolates *temporal credit assignment*:
learning **when** information is needed, not how it is encoded.

Key aspects:
* Discrete bit sequence (binary input/output).
* Delay is evolved via mutation, not predefined.
* Warm-up phase ensures delay buffers are filled before evaluation.
* Fitness combines MSE (continuous output) with thresholded accuracy.
* Visualization shows both probabilistic output and hard decisions.
* Delay values of recurrent connections are logged per generation.

<p align="center">
  <img src="./03_frames/03_delay_bitseq_echo.gif" alt="Delay Bit-Sequence Echo" width="512"/>
</p>

---

### `04_leaky_temporal_smoothing.py`

Shows the **core effect of leaky neuron dynamics**: temporal smoothing under noisy input.
...
* All temporal behavior comes only from neuron dynamics
* Plot shows input, EMA target, and best predictions
...
<p align="center">
  <img src="./05_frames/05_image_approximation.gif" alt="Image Approximation" width="512"/>
</p>

---

### `06_structural_xor.py`
...
<p align="center">
  <img src="./06_frames/06_structural_xor.gif" alt="Structural XOR" width="512"/>
</p>

---

### `07_recurrent_bit_prediction.py`
...
<p align="center">
  <img src="./07_frames/07_recurrent_bit_prediction.gif" alt="Recurrent Bit Prediction" width="512"/>
</p>

---

### `08_recurrent_timeseries.py`
...
<p align="center">
  <img src="./08_frames/08_recurrent_timeseries.png" alt="Recurrent Time Series Prediction" width="512"/>
</p>

---

### `09_recurrent_trading.py`
...
<p align="center">
  <img src="./09_frames/09_recurrent_trading.png" alt="Recurrent Trading Strategy" width="512"/>
</p>
